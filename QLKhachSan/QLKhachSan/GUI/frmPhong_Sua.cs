...
{
    public partial class frmPhong_Sua : Form
    {
        public frmPhong_Sua()
        {
            InitializeComponent();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    ret = doit.doStoredProceduce("suaPhong", li.ToArray());
                    doit.Close();
                    if (ret < 0)
                    {
        ...
        private void frmPhong_Sua_Load(object sender, EventArgs e)
        {
            
        }

        //USE DELEGATE TAKE DATA
        public void layData(DataGridView dgv)
        {
            txtMaPhong.Text = dgv.CurrentRow.Cells[0].Value.ToString();
            cmbMaLoai.Text = dgv.CurrentRow.Cells[1].Value.ToString();
        }

        

        private void cmbMaLoai_Click(object sender, EventArgs e)
        {
            //cmbMaLoai
            int ret = 0;
